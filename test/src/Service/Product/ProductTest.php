...
class ProductTest extends TestCase
{
    ...
    public function dataProviderProduct(): \Generator
    {
        ...
        yield 'product list' => [
            [
                new ProductEntity(3, 'Another', 50.11, 0.1, 0),
            ]
        ];
    }
    ...
    public function dataProviderAllProduct(): \Generator
    {
        ...
        yield 'product list' => [
            [
                new ProductEntity(3, 'Another', 50.11, 0.1, 0),
                new ProductEntity(10, 'Test', 199.99, 0.1, 0),
            ]
        ];

        yield 'product list with extreme values' => [
            [
                new ProductEntity(0, '', 0, 0.1, 0),
                new ProductEntity(PHP_INT_MAX, 'Test', 1.7976931348623e+308, 0.1, 0),
            ]
        ];
    }
}
